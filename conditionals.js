...
const moreThen = 10 > 20;
console.log("Is het 10 meer dan 20? " + moreThen)
...
const isUnequal = 20 != 11;
console.log("Is 10 ongelijk aan 11? " + isUnequal);
...
console.log(`is zoet hetzelfde als sappig ${isSame}`);
...
const cumLoude = raportCijfer > 8;

if (cumLoude) {
    console.log("Cum loude");
} else {
    console.log(`beter studeren vriend`)
}
...
if (!isRaining && temperature >= 21) {
    console.log(`Je  kunt een korte broek aan doen`);
} else if (isRaining && temperature <= 12) {
    console.log(`doe een jas aan kind`);
}